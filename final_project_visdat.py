...
kasbar= (data[(data['Country'] == 'Italy') | (data['Country'] == 'India') | (data['Country'] == 'Indonesia')]
               .loc[:, ['Date', 'Country', 'New_cases']]
               .sort_values(['Date']))
kasbar
...
it_data = kasbar[kasbar['Country'] == 'Italy']
ind_data = kasbar[kasbar['Country'] == 'India']
ina_data = kasbar[kasbar['Country'] == 'Indonesia']

# Membuat ColumnDataSource objek untuk setiap team
it_cds = ColumnDataSource(it_data)
ind_cds = ColumnDataSource(ind_data)
ina_cds = ColumnDataSource(ina_data)
...
frames = [ind_data, it_data, ina_data]
